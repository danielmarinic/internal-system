        ...
        },
        {
          ...
          children: [
            ...
            },
            {
              name: 'user-register',
              path: 'user/register',
              component: () => import('../components/forms/form-elements/UserRegister.vue'),
              meta: {
                wikiLink: 'https://github.com/epicmaxco/vuestic-admin/wiki/Medium-Editor',
              },
            },
            {
              ...
              path: 'department/:id',
              component: () => import('../components/forms/form-elements/DepartmentEdit'),
              meta: {
                wikiLink: 'https://github.com/epicmaxco/vuestic-admin/wiki/Medium-Editor',
              },
            },
            {
              name: 'project-edit',
              path: 'project/:id',
              component: () => import('../components/forms/form-elements/ProjectEdit'),
              meta: {
                wikiLink: 'https://github.com/epicmaxco/vuestic-admin/wiki/Medium-Editor',
              },
            },
            {
              ...
              component: () => import('../components/forms/form-elements/ProjectMember'),
              meta: {
                wikiLink: 'https://github.com/epicmaxco/vuestic-admin/wiki/Medium-Editor',
              },
            },
            {
              name: 'customer-edit',
              path: 'customer/:id',
              component: () => import('../components/forms/form-elements/CustomerEdit'),
              meta: {
                wikiLink: 'https://github.com/epicmaxco/vuestic-admin/wiki/Medium-Editor',
              },
            },
            {
              name: 'notice-edit',
              path: 'notice/:id',
              component: () => import('../components/forms/form-elements/NoticeEdit'),
              meta: {
                wikiLink: 'https://github.com/epicmaxco/vuestic-admin/wiki/Medium-Editor',
              },
            },
            {
              name: 'timesheet-edit',
              path: 'timesheet/:id',
              component: () => import('../components/forms/form-elements/TimesheetEdit'),
              meta: {
                wikiLink: 'https://github.com/epicmaxco/vuestic-admin/wiki/Medium-Editor',
              },
            },
            {
              name: 'user-edit',
              path: 'user/:id',
              component: () => import('../components/forms/form-elements/UserEdit'),
              meta: {
                wikiLink: 'https://github.com/epicmaxco/vuestic-admin/wiki/Medium-Editor',
              },
            },
        ...
        },
        {
          ...
          children: [
            ...
            },
            {
              name: 'users',
              path: 'users',
              component: () => import('../components/data-tables/Users.vue'),
              wikiLink: 'https://github.com/epicmaxco/vuestic-admin/wiki/Tables', // TODO Add docs
            },
            {
              name: 'departments',
              path: 'departments',
              component: () => import('../components/data-tables/Departments.vue'),
              wikiLink: 'https://github.com/epicmaxco/vuestic-admin/wiki/Tables', // TODO Add docs
            },
            {
              name: 'customers',
              path: 'customer',
              component: () => import('../components/data-tables/Customer.vue'),
              wikiLink: 'https://github.com/epicmaxco/vuestic-admin/wiki/Tables', // TODO Add docs
            },
            {
              name: 'projects',
              path: 'project',
              component: () => import('../components/data-tables/Project.vue'),
              wikiLink: 'https://github.com/epicmaxco/vuestic-admin/wiki/Tables', // TODO Add docs
            },
            {
              name: 'timesheets',
              path: 'timesheet',
              component: () => import('../components/data-tables/Timesheet.vue'),
              wikiLink: 'https://github.com/epicmaxco/vuestic-admin/wiki/Tables', // TODO Add docs
            },
            {
              name: 'project-timesheets',
              path: '/project/timesheet/:id',
              component: () => import('../components/data-tables/ProjectTimesheet.vue'),
              wikiLink: 'https://github.com/epicmaxco/vuestic-admin/wiki/Tables', // TODO Add docs
            },
          ],
        },
